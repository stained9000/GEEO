...
from .models import Escuela, Personal, Matricula, Destreza, Presupuesto, Visita, Actividad, Empleado, Municipio, CodigosDE, Propuesta, Ofrecimiento, PurchaseOrder, Servicio
